...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        _______, RGB_C1, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG,          RGB_TOG,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, RGB_SAI, RGB_HUD,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case RGB_C1:
            rgb_matrix_mode(RGB_MATRIX_CUSTOM_BREATHING_MULTISPLASH);
            return false;
        default:
            return true;
    }
...
void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    if (IS_HOST_LED_ON(USB_LED_CAPS_LOCK)) {
        ...
        int indexes[] = {
            8, 9, 10, 14, 15, 16, 20, 21, 22, 25, 26, 27,
            30, 31, 32, 36, 37, 38, 41, 42, 43, 46, 47,
            52, 53, 58, 59
        };
        ...
        //rgb_matrix_sethsv(hsv.h, hsv.v, 100);
    }
...
// TODO: Add the wanted effects to specific key combinations
